...
sudoku1212::sudoku1212(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::sudoku1212)
{this->setFixedSize(QSize(996, 718));
    ...
    ui->setupUi(this);
    QPixmap background (":/resource/12x12_background.png");
...
sudoku1212::~sudoku1212()
{
    delete ui;
}

void sudoku1212::on_newgame_clicked()
{
    counter = 0;
...
void sudoku1212::on_mytable_cellClicked(int row, int column)
{
    click_abs=row;
    click_ord=column;
}
void sudoku1212::on_number1_clicked()
{if(click_abs!=99){
    QFont font("Helvetica", 20, QFont::Bold);
...
void sudoku1212::on_number2_clicked()
{if(click_abs!=99){
...
void sudoku1212::on_number3_clicked()
{  if(click_abs!=99){
    QFont font("Helvetica", 20, QFont::Bold);
...
void sudoku1212::on_number4_clicked()
{   if(click_abs!=99){
...
void sudoku1212::on_number5_clicked()
{if(click_abs!=99){
...
void sudoku1212::on_number6_clicked()
{   if(click_abs!=99){
...
void sudoku1212::on_number7_clicked()
{  if(click_abs!=99){
...
void sudoku1212::on_number8_clicked()
{  if(click_abs!=99){
...
void sudoku1212::on_number12_clicked()
{   if(click_abs!=99){
...
void sudoku1212::on_number10_clicked()
{   if(click_abs!=99){
...
void sudoku1212::on_number11_clicked()
{   if(click_abs!=99){
...
void sudoku1212::on_number9_clicked()
{  if(click_abs!=99){
...
void sudoku1212::on_solveit_clicked()
{QFont font("Helvetica", 20, QFont::Bold);
    indsolved=1;
...
void sudoku1212::on_menu_clicked()
{    if(indsolved==0){
...
void sudoku1212::on_erase_clicked()
...
void sudoku1212::on_indication_clicked()
{
    int i,j;
    QFont font("Helvetica", 20, QFont::Bold);
...
void sudoku1212::UpdateTime()
{
    counter++;
    ui->timing->setText(QString("     %1 s  ").arg(counter) );
        }
void sudoku1212::on_savegame_clicked()
{
    save1212.open("/Users/hamzaelfarre/Desktop/28april/working/save/save1212.txt");
       save1212.close();

       fstream file("/Users/hamzaelfarre/Desktop/28april/working/save/save1212.txt",ios::app);
       for(int i=0;i<12;i++){
           for(int j=0;j<12;j++){
...
void sudoku1212::on_reload_clicked()
{
    QFont font("Helvetica", 20, QFont::Bold);
        int a=0;
        int c;
         fstream file("/Users/hamzaelfarre/Desktop/28april/working/save/save1212.txt");
        string content;
        string k;
        string tm;
